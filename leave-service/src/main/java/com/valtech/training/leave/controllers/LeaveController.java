...
public class LeaveController {
	...
	@PutMapping("/{id}")
	public LeaveVO updateLeave( @PathVariable long id,@RequestBody LeaveVO vo) {
	...
	public LeaveVO getLeave(@PathVariable ("id")long id) {
		...
		EmployeeVO man=leaveService.getManager(vo.empId());
		System.out.println("Emp= "+vo.empId()+" manager"+man.id());
		return vo;
	}
